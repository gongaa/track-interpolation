...
class Options():
	...
	def initialize(self):                
		...
		self.parser.add_argument('--track_obj_loss', dest='track_obj_loss',
										...
										action='store_true') 
		self.parser.add_argument('--obj_loss', dest='obj_loss',
										help='whether load coarse model ', 
										action='store_true') 
		self.parser.add_argument('--fus_obj_loss', dest='fus_obj_loss',
										help='whether load coarse model ', 
										action='store_true')  
		self.parser.add_argument('--obj_ce_loss', dest='obj_ce_loss',
										help='whether load coarse model ', 
										action='store_true')  
		...
		self.parser.add_argument('--obj_l1_w', dest='obj_l1_weight',
												...
												type=float,
												default=80)
		self.parser.add_argument('--obj_gdl_w', dest='obj_gdl_weight',
												help='training optimizer loss weigh of gdl',
												type=float,
												default=80)
		self.parser.add_argument('--obj_vgg_w', dest='obj_vgg_weight',
												help='training optimizer loss weigh of vgg',
												type=float,
												default=20)
		self.parser.add_argument('--obj_ssim_w', dest='obj_ssim_weight',
												help='training optimizer loss weigh of feat',
												type=float,
												default=20) 
		self.parser.add_argument('--obj_ce_w', dest='obj_ce_weight',
												help='training optimizer loss weigh of feat',
												type=float,
												default=30) 
		self.parser.add_argument('--obj_loc_diff_w', dest='obj_loc_diff_weight',
												help='training optimizer loss weigh of feat',
												type=float,
												default=100) 
		...
		inter_parser.add_argument('--gan', dest='gan',
												help='whether load coarse model ', 
												action='store_true')
		inter_parser.add_argument('--track_gen_test', dest='track_gen_test',
												help='whether load coarse model ', 
												action='store_true')
		...
		inter_parser.add_argument('--coarse_model', dest='coarse_model', 
										default='HRNet', 
										help='model to use',
										choices=['HRNet', 'VAEHRNet', 'TrackGenV4Test','TrackGenV7Test'])  					  
		...
		inter_parser.add_argument('--track_gen', dest='track_gen',
												help='whether train coarse model ', 
												action='store_true')
		inter_parser.add_argument('--track_gen_mask', dest='track_gen_mask',
												help='whether train coarse model ', 
												action='store_true')
		inter_parser.add_argument('--track_gen_model', dest='track_gen_model', 
										default='TrackGen', 
										help='model to use',
										choices=['TrackGen','TrackGenV2','TrackGenV2BatchNorm','TrackGenV3',
												'TrackGenV4','TrackGenV3plus','TrackGenV5','TrackGenV6', 
												'TrackGenV7', 'TrackGenV8', 'TrackGenV9', 'TrackGenV8plus']) 
		inter_parser.add_argument('--pretrained_track_gen', dest='pretrained_track_gen',
										help='whether train coarse model ', 
										action='store_true')
		inter_parser.add_argument('--pretrained_track_gen_model', dest='pretrained_track_gen_model',
										help='directory to load models', default="log",
										type=str)
		...
		inter_parser.add_argument('--mask_diff_w', dest='mask_diff_weight', 
										help='coarse learning rate',
		...
		inter_parser.add_argument('--load_frame_disc_model', dest='load_frame_disc_model', 
										...
										choices=['FrameDiscriminator', 'FrameLocalDiscriminator', 
												...
												'FrameDetDiscriminator', 'FrameSNDetDiscriminator', 'FrameLSSNDiscriminator'])  
		...
		### frame_context_disc model ###
		inter_parser.add_argument('--frame_context_disc', dest='frame_context_disc', 
										help='whether refine or not',
										action='store_true')  
		inter_parser.add_argument('--frame_context_disc_o', dest='frame_context_disc_optimizer', 
										help='training refine optimizer',
										choices =['adamax','adam', 'sgd'], 
										default="adamax")
		inter_parser.add_argument('--frame_context_disc_lr', dest='frame_context_disc_learning_rate', 
										help='refine learning rate',
										default=0.001, type=float)
		inter_parser.add_argument('--train_frame_context_disc', dest='train_frame_context_disc', 
										help='whether refine or not',
										action='store_true') 
		inter_parser.add_argument('--load_frame_context_disc', dest='load_frame_context_disc', 
										help='whether refine or not',
										action='store_true')  
		inter_parser.add_argument('--load_frame_context_disc_model', dest='load_frame_context_disc_model', 
										default='FrameDiscriminator', 
										help='refine model to use',
										choices=['FrameDiscriminator', 'FrameLocalDiscriminator', 
												'FrameSNDiscriminator', 'FrameSNLocalDiscriminator', 
												'FrameDetDiscriminator', 'FrameSNDetDiscriminator','FrameLSSNDetDiscriminator'])  
		inter_parser.add_argument('--frame_context_disc_model', dest='frame_context_disc_model', 
										default='FrameDiscriminator', 
										help='refine model to use',
										choices=['FrameDiscriminator', 'FrameLocalDiscriminator', 
												'FrameSNDiscriminator', 'FrameSNLocalDiscriminator', 
												'FrameDetDiscriminator', 'FrameSNDetDiscriminator','FrameLSSNDetDiscriminator'])
		inter_parser.add_argument('--frame_context_disc_d_w', dest='frame_context_disc_disc_weight', 
										help='whether refine or not',
										type=float,
										default=1) 
		inter_parser.add_argument('--frame_context_disc_g_w', dest='frame_context_disc_gen_weight', 
										help='whether refine or not',
										type=float,
										default=1) 
		...
		inter_parser.add_argument('--load_video_disc_model', dest='load_video_disc_model', 
										...
										choices=['VideoDiscriminator', 'VideoLocalDiscriminator', 
												...
												'VideoLSSNDetDiscriminator','VideoVecSNDetDiscriminator',
												'VideoPoolSNDetDiscriminator', 'VideoLSSNDiscriminator'])  
		...
		inter_parser.add_argument('--load_video_det_disc_model', dest='load_video_det_disc_model', 
										...
										choices=['VideoDiscriminator', 'VideoLocalDiscriminator', 
												'VideoSNDiscriminator', 'VideoSNLocalDiscriminator', 
												'VideoDetDiscriminator','VideoSNDetDiscriminator',
												'VideoLSSNDetDiscriminator', 'VideoLocalPatchSNDetDiscriminator','VideoMultiLocalPatchSNDetDiscriminator',
